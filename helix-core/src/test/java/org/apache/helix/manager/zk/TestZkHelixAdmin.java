...
public class TestZkHelixAdmin extends ZkUnitTestBase {
  ...
  public void testPurgeOfflineInstances() {
    ...
    znRecord.setSimpleField("LAST_OFFLINE_TIME",
        String.valueOf(System.currentTimeMillis() - 50000L));
    _baseAccessor.set(PropertyPathBuilder.instanceHistory(clusterName, instanceName),
        znRecord, 1);
    ...
    Map<String, Long> purgeMap = new HashMap<>();
    purgeMap.put("purge.timeout", 10000L);
