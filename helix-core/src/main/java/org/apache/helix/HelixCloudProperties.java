...
/**
 * hold helix cloud properties read from both user input properties and corresponding file under
 * helix-core/src/main/resources/
 */
public class HelixCloudProperties {
  ...
  /**
   * Initialize properties from user input and a file
   * user input properties has higher priority over the file content. When two property keys collide,
   * user input property overrides file property
